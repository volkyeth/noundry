export const lilNounsTokenContractAddress =
    "0x4b10701Bfd7BFEdc47d50562b76b436fbB5BdB3B" as `0x${string}`;
...
export const lilNounsTokenContract = {
    address: lilNounsTokenContractAddress,
