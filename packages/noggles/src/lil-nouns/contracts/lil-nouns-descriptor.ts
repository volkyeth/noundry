export const lilNounsDescriptorContractAddress =
  "0xb2a47999b3117c7dD628920ED8e77eBDfB948B68" as `0x${string}`;
...
export const lilNounsDescriptorContract = {
  address: lilNounsDescriptorContractAddress,
