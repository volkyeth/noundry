      ...
      <div className="flex flex-col gap-4 text-lg">
        <div className="flex flex-col gap-4">
          <p className="text-xl my-2 ">
            Lil Noundry is a platform for artists to create and share Lil Nouns
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>2. Upload your trait to Lil Noundry</p>
            <p>
              3. If you want your trait to be part of the official Lil Nouns
              collection:
            </p>
            <ul className="list-disc list-inside pl-4">
              <li>Submit a proposal</li>
              <li>
                If sponsored and successful, your trait becomes part of the Lil
                Nouns collection
              </li>
