export const nounsDaoDataAbi = [
  {
    inputs: [
      { internalType: "address", name: "nounsToken_", type: "address" },
  ...
  { inputs: [{ internalType: "bytes", name: "data", type: "bytes" }], name: "FailedWithdrawingETH", type: "error" },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint256", name: "oldCreateCandidateCost", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "newCreateCandidateCost", type: "uint256" },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint256", name: "oldUpdateCandidateCost", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "newUpdateCandidateCost", type: "uint256" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "createCandidateCost_", type: "uint256" },
      { internalType: "uint256", name: "updateCandidateCost_", type: "uint256" },
      { internalType: "address payable", name: "feeRecipient_", type: "address" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  { inputs: [], name: "nounsDao", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" },
  {
    inputs: [],
    name: "nounsToken",
  ...
  {
    inputs: [{ internalType: "uint256", name: "newCreateCandidateCost", type: "uint256" }],
  ...
  {
    inputs: [{ internalType: "uint256", name: "newUpdateCandidateCost", type: "uint256" }],
